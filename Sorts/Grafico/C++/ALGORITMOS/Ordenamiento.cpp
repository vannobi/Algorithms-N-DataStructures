...
int main(){
	...
	for(int n=1;n<=NUM_PUNTOS;n++){
		...
		valoresY2[n-1]=tiemposort2/1000;		
		//imprimir(arr2,n*paso-1);
		//cout<<endl;
		...
		valoresY3[n-1]=tiemposort3/1000;
		//imprimir(arr3,n*paso-1);
		//cout<<endl;
		...
		valoresY4[n-1]=tiemposort4/1000;
		//imprimir(arr4,n*paso-1);
		//cout<<endl;
		...
		valoresY5[n-1]=tiemposort5/1000;
		//imprimir(arr5,n*paso-1);
		//cout<<endl;		
		...
		valoresY6[n-1]=tiemposort6/1000;
		//imprimir(arr6,n*paso-1);
		//cout<<endl;
		...
		valoresY7[n-1]=tiemposort7/1000;
		//imprimir(arr7,n*paso-1);
		//cout<<endl;
